...
const ProfileCreationPage = () => {
  ...
  const createProfile = async () => {
    if (profileName.length < 2) {
      ...
      await ProfileService.createProfile(body);
      router.back();
    }
  };
      ...
      <View style={styles.inputsContainer}>
        <View style={styles.inputsWrapper}>
          ...
          <View style={styles.titleContainer}>
            ...
            />
            {errorVisible && (
              <Text style={styles.errorText}>Please enter a name for your profile</Text>
            )}
          </View>
          ...
          {/* Storage Mode Settings + Auto Switch */}
          <View style={styles.modeContainer}>
            <View style={styles.modeTitleContainer}>
              <Image
                source={require(storageModeIcon)}
                style={styles.modeImage}
                resizeMode="contain"
              />
            ...
            <View style={styles.storageOptions}>
              <View style={styles.storageOptionsInfo}>
                ...
                <Text style={styles.storageOptionsInfoSubtitle}>
                  Automatically switch to storage mode after the drying cycle is completed
                </Text>
              </View>
              <FilametricSwitch
                value={autoSwitchToStorage}
                onChange={setAutoSwitchToStorage}
              />
            </View>
          </View>
